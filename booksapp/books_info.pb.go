...
var file_books_info_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0xf5, 0x01, 0x0a, 0x08, 0x42, 0x6f,
...
var file_books_info_proto_depIdxs = []int32{
	...
	2, // 4: booksapp.BookInfo.ReadCsvFile:input_type -> booksapp.File
...
func _BookInfo_ReadCsvFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(File)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookInfoServer).ReadCsvFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/booksapp.BookInfo/ReadCsvFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookInfoServer).ReadCsvFile(ctx, req.(*File))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BookInfo_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookInfo_ReadCsvFile_Handler,
		},
	},

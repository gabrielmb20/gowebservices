...
var file_books_info_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0xf1, 0x01, 0x0a, 0x08, 0x42, 0x6f,
	...
	0x1a, 0x10, 0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x61, 0x70, 0x70, 0x2e, 0x42, 0x6f, 0x6f, 0x6b,
	0x49, 0x44, 0x12, 0x29, 0x0a, 0x07, 0x72, 0x65, 0x61, 0x64, 0x43, 0x53, 0x56, 0x12, 0x0e, 0x2e,
	0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x61, 0x70, 0x70, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x1a, 0x0e, 0x2e,
	0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x61, 0x70, 0x70, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x62, 0x06, 0x70,
...
var file_books_info_proto_depIdxs = []int32{
	...
	0, // 9: booksapp.BookInfo.readCSV:output_type -> booksapp.Book
...
type BookInfoClient interface {
	...
	ReadCSV(ctx context.Context, in *File, opts ...grpc.CallOption) (*Book, error)
}
...
func (c *bookInfoClient) ReadCSV(ctx context.Context, in *File, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
type BookInfoServer interface {
	...
	ReadCSV(context.Context, *File) (*Book, error)
}
...
func (*UnimplementedBookInfoServer) ReadCSV(context.Context, *File) (*Book, error) {
